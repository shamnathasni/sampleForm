...
app.post("/submit", (req, res) => {
  ...
  app.post("/receive", async (req, res) => {
    ...
    // Check for missing required fields in borrower data
    if (!borrowerData.borrowerPersonalDetails || !borrowerData.coBorrower) {
    ...
    try {
      ...
      res.json({
        ...
        responseFromReceiveRoute: data  // Optionally send back the original data
      });
    } catch (error) {
